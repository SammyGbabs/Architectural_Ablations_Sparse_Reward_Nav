...
- **Date:** 2026-07-04
- **Owner:** Samuel
- **Status:** **CLAIM-GRADE (P2-MS) — 10 seeds, frozen MAIN_SEEDS, rliable IQM+95% CI.** These are the reportable Phase 2 results; the single-seed §5 gates above stay in the record as *design decisions*, not results. (Run locally, CPU, W&B-disabled; identical configs/seeds reproduce on Colab.)
